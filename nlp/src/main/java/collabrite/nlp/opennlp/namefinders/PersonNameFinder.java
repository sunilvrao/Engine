...
public class PersonNameFinder{
    ...
    public void setUp() {
        InputStream is = getClass().getClassLoader().getResourceAsStream("opennlp/models/namefinder/en-ner-person.bin");
        if(is == null)
            throw new IllegalStateException("Unable to load NameFinder Model en-ner-person.bin");
