 ...
 * It's really easy with the Facebook Graph API. Sign in to Facebook and navigate to the 
 * <a href="https://developers.facebook.com/tools/explorer">Graph API Explorer app</a>. 
 * Click the "Get Access Token" button. That's it!
 * Keep in mind that this is only useful for quick testing. For production use, 
 * you'll need to create a Facebook Application and use it to obtain OAuth tokens for 
 * your users. Take a look at the FB Authentication documentation for more details.
 * </p>
 * <p>
